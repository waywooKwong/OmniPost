...
from adgraph_flow.crews.content_crew.content_crew import ContentCrew
from adgraph_flow.crews.pic_content_crew.pic_content_crew import PicContentCrew
...
class GuideCreatorFlow(Flow[GuideCreatorState]):
    ...
    def create_guide_outline(self, state):
        ...
        # Initialize the LLM
        llm = LLM(model="gemini/gemini-1.5-flash", response_format=GuideOutline)
